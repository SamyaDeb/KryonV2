...
export const CONTRACTS = {
  ...
  vault: envOrDefault("NEXT_PUBLIC_CONTRACT_VAULT", "CAULDUKSV4TRBCCFARMCS2D6SY2MJ4GDYUD4YNWTBKRY6WJGWA3HLAJ4"),
  engine: envOrDefault("NEXT_PUBLIC_CONTRACT_ENGINE", "CDGU5MYLXY6N3ABCOTFLL665B7UNIHSBYDDAL22A2KREGLDOHODCJEG5"),
  orderGateway: envOrDefault("NEXT_PUBLIC_CONTRACT_ORDER_GATEWAY", "CBHC7IDQX3GLPRDRQXU2YJSO5SWVTXSTWIH5QS5FSC4VZXWAS3VPCOZU"),
